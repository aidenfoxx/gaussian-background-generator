 ...
 * @twitter    @furiousfoxx
 */
function GaussianBackground(d,c,a){if(!(this instanceof GaussianBackground))return new GaussianBackground(d,c,a);this.animationFrame=this.context=null;this.lastCallTime=this.firstCallTime=this.timestep=0;this.layers={};this.layersBackup={};this.options={blur:!0,blurRadius:50,blurMethod:"stackblur",blurIterations:1,animation:!0,fpsCap:20,renderWidth:320,renderHeight:130};if(!(this.context=d.getContext("2d")))return console.log("ERROR: Could not load canvas"),!1;this.updateOptions(a);this.updateLayers(c);
